"""Run a WildBoar art phase with process exit validation and isolated plugin flags."""
...
SCRIPTS = {"library": "import_wild_boar_library.py", "assemblies": "build_wild_boar_assemblies.py",
           "audit": "audit_wild_boar_library.py", "render": "capture_wild_boar_editor_preview.py"}


def main():
    stage = sys.argv[1]
    script = PROJECT / "Scripts/Enemies" / SCRIPTS[stage]
    log = PROJECT / "Saved/Logs" / f"WildBoar_{stage}_20260915.log"
    report = PROJECT / "Saved/ImportReports" / f"WildBoar_Process_{stage}_20260915.json"
    ...
    if stage == "render":
        args = [str(ENGINE / "UnrealEditor.exe"), *common,
                "/Game/_Art/Enemies/Shared/Beasts/WildBoar/Preview/L_EN_WildBoar_Catalogue",
