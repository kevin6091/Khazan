...
import verify_wild_boar_render as verifier
...
def on_tick(delta_seconds):
    ...
    try:
        ...
        (PROJECT / "Saved/ImportReports/WildBoar_EditorPreviewFailure.txt").write_text(traceback.format_exc(), encoding="utf-8")
