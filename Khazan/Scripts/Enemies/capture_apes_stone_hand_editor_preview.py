...
import verify_apes_stone_hand_render as verifier
...
def on_tick(delta_seconds):
    ...
    try:
        ...
        (PROJECT / "Saved/ImportReports/ApesStoneHandElite_EditorPreviewFailure.txt").write_text(traceback.format_exc(), encoding="utf-8")
