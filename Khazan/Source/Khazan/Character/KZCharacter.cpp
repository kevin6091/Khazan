...
UAbilitySystemComponent* AKZCharacter::GetAbilitySystemComponent() const
{
	return AbilitySystemComponent.Get();
}

void AKZCharacter::PostInitializeComponents()
{
...
void AKZCharacter::PossessedBy(AController* NewController)
{
