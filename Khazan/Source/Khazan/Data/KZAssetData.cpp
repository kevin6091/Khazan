...
void UKZAssetData::PostLoad()
{
	Super::PostLoad();
	RebuildRuntimeLookupMaps();
}

void UKZAssetData::PreSave(FObjectPreSaveContext ObjectSaveContext)
{
	Super::PreSave(ObjectSaveContext);
	RebuildRuntimeLookupMaps();
}

void UKZAssetData::RebuildRuntimeLookupMaps()
{
...
FSoftObjectPath UKZAssetData::GetAssetPathByName(const FGameplayTag& AssetName)
{
...
const FAssetSet* UKZAssetData::GetAssetSetByLabel(const FGameplayTag& Label)
{
